...
type Info = I (List Int) | S (List String)

type alias DictInfo = D.Dict String Info

type alias Actor = {info: DictInfo, locs:List (Int,Int)}

--setting and getting for DictInfo and Actor

getIs : String -> DictInfo -> List Int
getIs str d = maybe [] (\i -> (case i of 
                               I ls -> ls
                               S ls -> [])) (D.get str d)

agetIs: String -> Actor -> List Int
...
getSs : String -> DictInfo -> List String
getSs str d = maybe [] (\i -> (case i of 
             I ls -> []
             S ls -> ls)) (D.get str d)

agetSs: String -> Actor -> List String
...
adirFrom dir a = dirFrom dir (withDefault (0,0) (a.locs!0)) 

setLoc: (Int,Int) -> Actor -> Actor
setLoc (x,y) a = setLocs [(x,y)] a

setLocs: List (Int,Int) -> Actor -> Actor
